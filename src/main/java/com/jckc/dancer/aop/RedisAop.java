package com.jckc.dancer.aop;


import com.jckc.dancer.common.annotation.RedisCache;
...
public class RedisAop {
     ...
     */
    @Pointcut("@annotation(com.jckc.dancer.common.annotation.RedisCache)")
    public void redisCache(){}

    /**
     *  给所有业务的数据的插入，更新，删除设置切点
     */
    @Pointcut("execution(* com.jckc.dancer.modules.*.service..*.insert*(..)) || " +
              "execution(* com.jckc.dancer.modules.*.service..*.batch*(..)) || " +
              "execution(* com.jckc.dancer.modules.*.service..*.update*(..)) || " +
              "execution(* com.jckc.dancer.modules.*.service..*.delete*(..))" )
