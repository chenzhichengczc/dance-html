...
public class TransactionAdviceAOP {
     ...
     * 定义切点
     */
    private static final String AOP_POINT_CUT = "execution(* com.jckc.dancer.modules.*.service..*.*(..))";
    ...
    public TransactionInterceptor txAdvice(){
        ...
        map.put("check*", ruleChange);
        map.put("save*", ruleChange);
        map.put("wx*", ruleChange);
