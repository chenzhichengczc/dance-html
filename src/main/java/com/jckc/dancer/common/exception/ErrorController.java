...
package com.jckc.dancer.common.exception;
...
public class ErrorController extends BasicErrorController {
    ...
    public ResponseEntity error(HttpServletRequest request) {
        ...
        if((Integer)body.get("status") == 500 && ((String)body.get("message")).contains("会话")){

            ret = ResponseUtil.error(HttpStatus.UNAUTHORIZED.value(), jsonCommonResult);;
