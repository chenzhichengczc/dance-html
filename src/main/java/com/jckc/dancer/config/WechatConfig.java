...
public class WechatConfig {
    ...
    //用户支付成功后的服务器回调url，这里填PayControlle里的回调函数地址
    public static final String user_notify_url = "https://www.jinpaiwuban.com/wx/wxPay/wxNotify";
    //教练支付成功后的服务器回调url
    public static final String coach_notify_url = "https://www.jinpaiwuban.com/wx/coach/wxPay/wxNotify";
    //签名方式，固定值
